        ...
        <div className='container flex justify-between'>
          <div className='infos w-[45%] mt-4 py-2 '>
            ...
            <div className='flex gap-8 mt-8'>
              <div className='flex flex-col items-center'>
                <div className='w-[12px] h-[12px] rounded-full bg-secondary-gray border-2 border-primary-yellow'></div>
                <div className='h-full w-[2px] bg-primary-white opacity-95'></div>
                <div className='w-[12px] h-[12px] rounded-full bg-secondary-gray border-2 border-primary-yellow'></div>
              </div>
              <div
                className='
                border-[1px] border-primary-yellow px-2.5 py-2 capitalize w-full
              ...
              '>
                ...
                <p className='opacity-90 text-lg'>the higher school of computer science ESI <span className='normal-case'>ex</span>  INI - Algiers  </p>
                <p className='text-primary-yellow'>year 2020 - present</p>
                <p className='normal-case opacity-95 '>
                  ...
                  I'm proficient in problem solving and data structures and algorithms using C and JAVA.
          ...
          <div className='infos w-[45%] mt-4 py-2'>
            ...
            <div className=' flex gap-8 mt-8'>
              ...
              <div
                className='
                border-[1px] border-primary-yellow px-2.5 py-2 capitalize w-full text-center
                hover:bg-very-dark-blue hover:shadow-[4px_4px_0px_#ffd700] hover:-translate-y-1 transition-transform duration-150 ease-in
              '>
                pending ...
              </div>
